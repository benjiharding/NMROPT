...
contains
   ...
   subroutine test_sequential_simulation(sim)
      ...
      !
      xyz(1, :) = [0.25, 0.75, 0.25]
      xyz(2, :) = [0.25, 0.25, 0.75]
      xyz(3, :) = [0.d0, 0.d0, 0.d0]

      ! sim quantiles
      q = [0.294665, 0.53058676, 0.19152079]

      ! spherical variogram model with a isotropic range of 0.6
      vm(1)%nst = nst
      vm(1)%c0 = 0.0
   ...
   end subroutine test_sequential_simulation
