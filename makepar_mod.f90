...
contains
   ...
   subroutine makepar(parfile)
      ...
      write (99, "(A)") '1                                 - normal score transform var? (0=no, 1=yes)'
      ...
      write (99, "(A)") '1  1  1  0                        - objective components: varg, ivarg, runs, npoint'
      ...
      write (99, "(A)") '2.5                               - IDW power for variogram optimization weighting'
